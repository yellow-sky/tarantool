...
replica_set.join(test_run, 'errinj')
...
replica_set = require('fast_replica')
replica_set.join(test_run, 'errinj_timeout', 1, 'replica_timeout')
box.cfg{replication_timeout = 0.01, replication_connect_timeout = 0.5}
