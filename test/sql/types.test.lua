...
box.execute([[SELECT position(NULL, 1);]])
box.execute([[SELECT position(1, NULL);]])
...
box.execute([[SELECT replace(NULL, 1, 'a');]])
box.execute([[SELECT replace('a', NULL, 1);]])
box.execute([[SELECT replace(1, 'a', NULL);]])
...
box.execute([[SELECT substr(NULL, '1', 1);]])
box.execute([[SELECT substr('a', NULL, '1');]])
box.execute([[SELECT substr(1, 1, NULL);]])
...
box.execute([[SELECT 1 like NULL;]])
box.execute([[SELECT NULL like 1;]])
...
box.execute([[SELECT group_concat(n, i) FROM t;]])
box.execute([[SELECT group_concat(i, n) FROM t;]])
